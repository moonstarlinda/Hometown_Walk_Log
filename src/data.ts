...
export const INITIAL_LOGS: WalkLog[] = [
  ...
  },
  {
    ...
    date: '2026-06-20',
    weather: 'cloudy',
    weatherText: '阴天 ☁️，26°C，有风不晒',
    tags: ['周六', '短裤', '老夫妇', '选酸奶还是基地'],
    content: '周六上午出来溜达。26度但有风，一点都不热。穿了短裤出门。下桥时遇到经常碰见的那对老年夫妇——每次都是我刚到，他们好像已经走完了。在一号基地坐了一会儿，阴天阳光柔和，水没有那么亮但流速很快。河中间没有鸭子。对岸一个钓鱼人都没有（神奇）。沙土潮湿，两只脚踩出了两个痕迹。纠结去超市买酸奶还是去二号基地看云——后来一只母鸭出现在沙洲中，灰褐色。她替我在犹豫中做了选择：继续上路。'
  },
  {
    id: 'log-1-3',
    baseId: 'base-1',
    date: '2026-06-21',
    weather: 'windy',
    weatherText: '大风💨，阴天☁️，夏至却不像夏至',
    tags: ['夏至', '困但出门', '林中不安', '水浑'],
    content: '夏至，但一点也不像夏至——大风阴天。困但强撑着出门。水有点浑。对岸没有钓鱼人，沙洲中有两只鸭子。林中小路像进了另一个世界的入口，有点不安。碰见紫色跑步老头🏃‍♂️💜。'
  },
  ...
  },
  {
    ...
    date: '2026-06-20',
    weather: 'cloudy',
    weatherText: '纯灰白厚云层 ☁️，有风',
    tags: ['偏光墨镜观测', '云如玉石纹理', '穿林打叶声', '苏东坡', 'On the Nature of Daylight', '野餐'],
    content: '路上BGM：On the Nature of Daylight 🎻。从一号到二号基地的路上，风从山顶刮下来，山上的树沿山坡与路面呈90度生长，像向路上压来。风吹下许多落叶，突然想到苏东坡的「莫听穿林打叶声」。到二号基地，长椅空着。戴上偏光墨镜观测天空——云彩纹理像玉石上偶尔透出的一缕亮色。云从南向北运动。刚观测完就刮起大风——「树木想登台表演」。带了蓝莓樱桃牛板筋QQ糖海苔。朋友发消息说同龄人都在生孩子。QQ糖吃完了就没事了。'
  },
  {
    id: 'log-2-11',
    baseId: 'base-2',
    date: '2026-06-21',
    weather: 'windy',
    weatherText: '阴云 ☁️+大风💨，云层有亮光纹理',
    tags: ['夏至', 'NPC大爆发', '蚂蚁蓝莓实验', '蓝色自行车', '榆钱雪'],
    photos: [
      '/images/base_2_2026_06_21.jpg'
    ],
    content: '夏至。到二号基地时旁边停了辆SUV，长椅后有蓝色老式自行车。云从西向东缓慢运动，有些从南向北——方向有变化。途中观察蚂蚁：大小两种，桌边折返，能爬垂直面但不久。扔蓝莓实验失败🫐✖️。\n\nNPC阵容：\n🏃‍♂️💜紫色跑步老头\n🚴‍♂️🚴‍♀️💚绿色骑车情侣被森林吃掉\n🚲👩日式骑车女士（白衬衫+卷发+棕帽+老式单车）\n🗣️大喊大叫女生（假装没看见）\n🚲学我看云的骑车老者😹\n\n野餐时老夫妇路过打量。树上像下雪一样掉榆钱🍃❄️，就几秒钟。昨天的橘子皮还在但烟头被收拾了🧹。'
  },
